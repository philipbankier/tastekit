...
import { createSession, loadSession, saveSession, Interviewer, DomainRubric } from '@kairox_ai/tastekit-core/interview';
import { resolveProvider, autoDetectProvider, type LLMProviderConfig } from '@kairox_ai/tastekit-core/llm';
import { getDomainRubric } from '@kairox_ai/tastekit-core/domains';
import { WorkspaceConfig, InterviewState } from '@kairox_ai/tastekit-core/schemas';
...
export const onboardCommand = new Command('onboard')
  ...
  .option('--voice', 'Enable voice mode (requires @kairox_ai/tastekit-voice and sox)')
  .action(async (options: OnboardOptions) => {
    ...
    try {
      ...
      if (options.voice) {
        try {
          const { createVoiceIO } = await import('@kairox_ai/tastekit-voice');
