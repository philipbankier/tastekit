  ...
  return [
    {
      playbook: {
        ...
        description: 'Quick workflow: build a voice brief, draft options, and wait for user selection.',
        triggers: [
          { type: 'manual' },
        ],
        inputs: [
          ...
          { name: 'audience', type: 'string', required: false, description: 'Target reader group and desired reader action' },
        ...
        steps: [
          ...
          {
            step_id: 'build-voice-brief',
            type: 'tool',
            tool_ref: 'skill:content-voice-brief',
            params_template: {
              goal: 'Draft a {{platform}} post about {{topic}}',
              audience: '{{audience || "target readers"}}',
              source_material: '{{context_summary}}',
              constraints: '{{tone_override || "use the compiled editorial profile"}}',
            },
            outputs: ['voice_brief'],
          },
          {
            step_id: 'draft-options',
            type: 'tool',
            tool_ref: 'skill:content-draft-options',
            params_template: {
              voice_brief: '{{voice_brief}}',
              source_material: '{{topic}}',
              format_constraints: '{{platform}} post, 3 options',
            },
    ...
    },
    {
      playbook: {
        ...
        description: 'Full workflow: build a voice brief, research current context, draft options, and review.',
        triggers: [
          { type: 'manual' },
        ],
        inputs: [
        ...
        steps: [
          {
            ...
            tool_ref: 'skill:content-voice-brief',
            params_template: {
              goal: 'Draft a research-informed {{platform}} post for {{niche}}',
              audience: '{{audience || "target readers"}}',
              source_material: '{{niche}}',
              constraints: '{{timeframe || "past week"}} trend context',
            },
            outputs: ['voice_brief'],
          },
          {
            ...
            tool_ref: 'web-search',
            params_template: {
              query: '{{niche}} trends {{platform}} {{timeframe || "past week"}}',
            },
            outputs: ['trend_data'],
          },
          {
          ...
          },
          {
            ...
            params_template: {
              voice_brief: '{{voice_brief}}',
              source_material: '{{selected_angle}}\n\nResearch context:\n{{trend_data}}',
              format_constraints: '{{platform}} post, 3 options',
            },
            outputs: ['post_options'],
          },
        ...
        steps: [
          {
            ...
            tool_ref: 'web-search',
            params_template: {
              query: '{{niche}} trends {{platforms}} past week',
            },
            outputs: ['trend_data'],
          },
          {
