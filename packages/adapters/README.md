...
Adapters produce runtime files and skills that can travel beyond the direct adapter list. The "32+ compatible runtimes" claim is compatibility through the AGENTS.md ecosystem plus Agent File and the direct adapters, not 32 dedicated TasteKit adapters.
